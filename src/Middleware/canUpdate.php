<?php
    ...
    namespace Actcmsvn\LaravelInstaller\Middleware;

    use Closure;
    use Actcmsvn\LaravelInstaller\Helpers\MigrationsHelper;
    use Actcmsvn\LaravelInstaller\Middleware\canInstall;
